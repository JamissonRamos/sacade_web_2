...
*/
    const result = data.map((item) => {
        ...
        const overdueInstallments = dataInstallments.filter((installment) => {
            ...
            return (
                dateExpiration.getDate() < currentDay &&
                dateExpiration.getMonth() + 1 === currentMonth && 
                dateExpiration.getFullYear() === currentYear
            );  
...
export const DelayMonthlyPaymentsMonth = (dataStudents, dataInstallments) =>{
    ...
    */
    ...
    //Calcular os meu juros e mensalidades vencidas
