...
export const FilterSortDate = (data) => {
    ...
    const sortedData = data.sort((a, b) => {
        // Se a.currentHistory for true, ele deve vir primeiro
        if (a.currentHistory && !b.currentHistory) {
            return -1;
        }
        // Se b.currentHistory for true, ele deve vir primeiro
        if (!a.currentHistory && b.currentHistory) {
            return 1;
        }
        // Se ambos têm o mesmo valor de currentHistory, ordena por data
        return parseDate(b.dateUpdate) - parseDate(a.dateUpdate);
    });
