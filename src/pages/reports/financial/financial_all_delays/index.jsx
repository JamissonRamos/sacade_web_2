...
import { ExtractStudentData } from '../../scripts';
import { AllMonthlyFeesDue } from '../../../../hooks/consultations/students_installments/all_delay_insllments';
import { useNavigate } from 'react-router-dom';
import Body from './body';

const FinancialAllDelays = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const resultCls = AllMonthlyFeesDue(resultExtractStudents, installmentsResult.data);
...
export default FinancialAllDelays