...
import { ConvertDateBrUSS } from '../../scripts';
...
const FormUpdate = (props) => {
    ...
    const fetchDocuments = async () => {
        ...
        if (success) {
            ...
            setValue('installmentDiscount', installmentDiscount);
            setValue('installmentIncrease', installmentIncrease);
            setValue('amountPaid', amountPaid);
        } else {
