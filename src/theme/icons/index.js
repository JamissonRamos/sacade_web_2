...
export const Icons = {  
    ...
    MdOutlineArrowBackIos:      MD.MdOutlineArrowBackIos,
    MdAddCircle:                MD.MdAddCircle,
    MdPerson:                   MD.MdPerson,
    MdAttachMoney:              MD.MdAttachMoney,
    ...
    MdCreditCard:               MD.MdCreditCard,
    MdAddCard:                  MD.MdAddCard,
    MdCalendarMonth:            MD.MdCalendarMonth,
    MdStarBorderPurple500:      MD.MdStarBorderPurple500,
    MdHelp:                     MD.MdHelp,
    MdPayments:                 MD.MdPayments,
    MdCheck:                    MD.MdCheck,
    MdHeight:                   MD.MdHeight,
    MdMonitorWeight:            MD.MdMonitorWeight,
    ...
    FaMoneyCheckAlt:            FA.FaMoneyCheckAlt,             
    FaMale:                     FA.FaMale,             
    FaFemale:                   FA.FaFemale,             
    FaWeight:                   FA.FaWeight,             
